...
if [ ! -z $NVM_THEME_PROMPT_COLOR ]; then
    NVM_THEME_PROMPT_COLOR=$(eval echo $`echo ${NVM_THEME_PROMPT_COLOR}`);
else
    NVM_THEME_PROMPT_COLOR="${yellow}"
fi
NVM_THEME_PROMPT_PREFIX="(${NVM_THEME_PROMPT_COLOR}node${normal}: "
