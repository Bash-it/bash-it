...
1. Clone this repo: `git clone http://github.com/revans/bash-it.git ~/.bash_it`
...
**NOTE:**
The install script will also prompt you to ask if you use [Jekyll](https://github.com/mojombo/jekyll).
...
There are a few bash it themes. If you've created your own custom prompts, I'd love it if you shared with everyone else!  Just submit a Pull Request to me [revans](https://github.com/revans).
